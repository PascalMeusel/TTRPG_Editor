...
from map.map_controller import MapController # Import the new controller
...
class AppController:
    ...
    def __init__(self, root):
        ...
        self.map_editor_tab = self.notebook.add("Map Editor") # New tab
        self.map_viewer_tab = self.notebook.add("Map Viewer") # New tab
        ...
        self.map_controller = MapController(self, self.map_editor_tab, self.map_viewer_tab) # Initialize it
    ...
    def on_rule_set_loaded(self, rule_set):
        ...
        # Note: The map feature is independent of the rule set for now
