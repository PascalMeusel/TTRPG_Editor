...
class CombatView:
    ...
    def show_simulator(self, controller):
        self.initial_label.pack_forget() # Hide the initial message

        combatant_frame = ctk.CTkFrame(self.content_frame, fg_color="transparent")
        ...
        output_frame = ctk.CTkScrollableFrame(self.content_frame, label_text="Result Log")
